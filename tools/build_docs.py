...
DOCS = [
    ...
    ("joints",          "docs/JOINTS.md",           "Joint contracts",
     "Executable locators, fastening stacks, access paths, seating, and load-path gates.", "Build"),
    ("mechanism-audit", "docs/MECHANISM_AUDIT.md",  "Mechanism audit",
     "Part-group mechanism verdicts and the executable evidence behind each one.", "Build"),
